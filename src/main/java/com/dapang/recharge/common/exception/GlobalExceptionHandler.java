package com.dapang.recharge.common.exception;

import cn.hutool.core.exceptions.ExceptionUtil;
import cn.hutool.core.util.ObjUtil;
import cn.hutool.core.util.StrUtil;
import com.dapang.recharge.common.exception.util.ServiceExceptionUtil;
...
import static com.dapang.recharge.common.exception.enums.GlobalErrorCodeConstants.*;
...
//        }
    ...
    public Result<?> methodArgumentTypeInvalidFormatExceptionHandler(HttpMessageNotReadableException ex) {
        ...
        if(ex.getCause() instanceof InvalidFormatException) {
            ...
            return Result.error(BAD_REQUEST.getCode(), String.format("请求参数类型错误:%s", invalidFormatException.getValue()));
        }else {
...
//    private Result<?> noResourceFoundExceptionHandler(HttpServletRequest req, NoResourceFoundException ex) {
//        log.warn("[noResourceFoundExceptionHandler]", ex);
//        return Result.error(NOT_FOUND.getCode(), String.format("请求地址不存在:%s", ex.getResourcePath()));
//    }
...
//        createExceptionLog(req, ex);
    ...
    private Result<?> handleTableNotExists(Throwable ex) {
        ...
        if (message.contains("report_")) {
            ...
            return Result.error(NOT_IMPLEMENTED.getCode(),
