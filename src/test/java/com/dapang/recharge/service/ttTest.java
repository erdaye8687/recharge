...
public class ttTest {
    ...
    public static void main(String[] args) {
        ...
        //手动配置数据源
        String url="jdbc:mysql://101.34.116.84:3309/recharge?serverTimezone=UTC&useUnicode=true&characterEncoding=utf-8";   //注意修改数据库名
        String name="root";
        ...
        //基本信息
        String author = "cainiao";    //作者
        String parent = "com.dapang";   //父包名
        String module = "recharge";   //模块包名
        //1、配置数据源
...
//                            .logicDeletePropertyName("isDeleted")  //逻辑删除属性名(实体)
                            .addIgnoreColumns("id", "create_time", "update_time", "creator", "operator", "is_deleted") //设置忽略的字段
                            .superClass("com.dapang.recharge.pojo.po.BasePO") //设置父类
